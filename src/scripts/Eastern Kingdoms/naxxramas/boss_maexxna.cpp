            ...
            switch (eventId)
            {
                ...
                case EVENT_SUMMON_SPIDERLING:
                {
                    ...
                    for (uint8 i = 0; i < count; ++i)
                        if (Creature * spiderling = m_creature->SummonCreature(MAEXXNA_SPIDERLING_ID, tmpPos.m_positionX, tmpPos.m_positionY, tmpPos.m_positionZ, tmpPos.o, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 20000))
