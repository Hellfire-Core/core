...
Unit* PetAI::FindValidTarget()
{
    ...
    MaNGOS::AnyUnfriendlyUnitInPetAttackRangeCheck u_check(m_creature);
    MaNGOS::UnitListSearcher<MaNGOS::AnyUnfriendlyUnitInPetAttackRangeCheck> searcher(targets, u_check);
