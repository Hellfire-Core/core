...
void CreatureEventAIMgr::LoadCreatureEventAI_Texts(bool check_entry_use)
{
    ...
    // Load EventAI Text
    sObjectMgr.LoadMangosStrings(GameDataDatabase,"creature_ai_texts",MIN_CREATURE_AI_TEXT_STRING_ID,MAX_CREATURE_AI_TEXT_STRING_ID);
    ...
    if (result)
    {
        ...
        do
        {
            ...
            if (!sObjectMgr.HasMangosString(i))
            {
