...
struct Position
{
    Position() : m_positionX(0.0f), m_positionY(0.0f), m_positionZ(0.0f), o(0.0f) {}
    Position(float x, float y, float z, float o = 0.0f) : m_positionX(x), m_positionY(y), m_positionZ(z), o(o) {}
    float m_positionX, m_positionY, m_positionZ, o;
...
public:
    ...
    bool operator!=(const Position &b) const { return m_positionX != b.m_positionX || m_positionY != b.m_positionY || m_positionZ != b.m_positionZ/* || o != b.o*/; }
};
...
class WorldObject : public Object//, public WorldLocation
{
    ...
    public:
        ...
        void GetPosition(Position* pos) const
            { pos->m_positionX = m_positionX; pos->m_positionY = m_positionY; pos->m_positionZ = m_positionZ; pos->o = m_orientation; }
